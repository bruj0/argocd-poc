...
echo
helm repo add --insecure-skip-tls-verify gitea-charts https://dl.gitea.io/charts/
helm repo add --insecure-skip-tls-verify argo https://argoproj.github.io/argo-helm
helm repo update
